...
# Modified by HUANG Kunlun Apr 2024
...
YABS_VERSION="v2024-04-09"

echo -e '# ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## #'
echo -e '#       Yet-Another-Bench-Script-fro NextEPC         #'
echo -e '#                     '$YABS_VERSION'                #'
echo -e '# https://github.com/kunlunh/nextepc/testscript      #'
echo -e '# ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## #'
